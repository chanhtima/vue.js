...
$(document).ready(function () {
  ...
  if ($("#search").length > 0) {
    $("#search").typeahead({
      source: function source(product_name, process) {
        return $.get("/set_search_product", {
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\template2.mwz\Modules\Mwz\Resources\assets\js\front.js */"./Resources/assets/js/front.js");
