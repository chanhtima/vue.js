...
(function ($) {
  ...
  var DIV_CARD = 'div.card'; // ______________Tooltip

  $('[data-toggle="tooltip"]').tooltip(); // ______________Popover
  ...
  toggleSidebar();
  $(window).resize(toggleSidebar); //Date range as a button
  ...
  $('.horizontal-left-icon').click(function () {
    /* box Switch*/
