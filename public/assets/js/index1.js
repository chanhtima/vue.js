...
$(function (e) {
  ...
  function myFunction() {
    document.querySelector('#timeline-chart').classList.toggle('margit');
  }
  /*Chart2 js*/
  ...
  var options = {
    ...
    fill: {
      ...
      opacity: 0.85,
      image: {
        src: ['http://localhost:8000/assets/images/photos/18.jpg', 'http://localhost:8000/assets/images/photos/21.jpg', 'http://localhost:8000/assets/images/photos/22.jpg', 'http://localhost:8000/assets/images/photos/12.jpg', 'http://localhost:8000/assets/images/photos/32.jpg'],
        width: 25,
        imagedHeight: 25
      }
    },
