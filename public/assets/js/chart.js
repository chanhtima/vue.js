...
(function ($) {
  ...
  var myChart = new Chart(ctx, {
    ...
    data: {
      datasets: [{
        data: [45, 25, 20, 10],
        backgroundColor: ["#5eba00", "#467fcf", "#5b5be9", "#f5334f"],
        hoverBackgroundColor: ["#5eba00", "#467fcf", "#5b5be9", "#f5334f"]
      }],
  ...
  var myChart = new Chart(ctx, {
    ...
    data: {
      datasets: [{
        data: [15, 18, 9, 6, 19],
        backgroundColor: ["#5eba00", "#467fcf", "#5b5be9", "#f5334f", "#ffb229"]
      }],
