...
/*!**********************************************!*\
  !*** ./resources/assets/js/chart-dygraph.js ***!
  \**********************************************/
// Darken a color
...
colors: ["#467fcf", "#f95058", "#32cafe", "#fc0", "#22c03c", "#467fcf", "#467fcf", "#467fcf", "#467fcf", "#467fcf", "#467fcf", "#467fcf", "#467fcf", "#467fcf", "#467fcf", "#467fcf", "#467fcf"];

function barChartPlotter(e) {
  var ctx = e.drawingContext;
  var points = e.points;
  var y_bottom = e.dygraph.toDomYCoord(0);
  ctx.fillStyle = darkenColor(e.color); // Find the minimum separation between x-values.
  ...
  var bar_width = Math.floor(2.0 / 3 * min_sep); // Do the actual plotting.
...
g = new Dygraph(document.getElementById("demodiv"), "Date,Widgets Sold\n" + "2012/07/21,10\n" + "2012/07/22,12\n" + "2012/07/23,9\n" + "2012/07/24,16\n" + "2012/07/25,10\n", {
  legend: 'always',
  title: '',
  includeZero: true,
...
function multiColumnBarPlotter(e) {
  ...
  var ctx = e.drawingContext;
  var sets = e.allSeriesPoints;
  var y_bottom = e.dygraph.toDomYCoord(0); // Find the minimum separation between x-values.
  // This determines the bar width.
