    ...
    invalidHandler: function(form, validator) {
      ...
      if (errors) {
        ...
        localStorage.setItem(
          $(tab_wrapper).attr("id") + "_activeTab",
          tab_active_index
        );
      ...
      .each(function() {
        ...
        $(zipcode).keyup(function() {
          if ($(zipcode).val().length == 5 && $.isNumeric($(zipcode).val())) {
            $.ajax({
              url:
                "/admin/mwz/get_address_by_zipcode/select2/" + $(zipcode).val(),
              type: "GET",
              dataType: "json",
...
int_mwz_datetimepicker = function() {
...
mwz_multi_upload_process = function(upload_element,parent_resp){
...
mwzGenerateMatadata = function (force = 1, langs = ['th', 'en'], slug_field = 'name', title_field = 'name', keywords_field = 'name', desc_field = 'desc'){
