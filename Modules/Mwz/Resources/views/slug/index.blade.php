...
@section('content')
    ...
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">ตั้งค่า Slug</li>
        </ol><!-- End breadcrumb -->
        @if (mwz_roles('admin.setting.slug.sitemap'))
            <div class="ml-auto">
                <div class="input-group">
                    <a href="{{ route('admin.mwz.slug.sitemap') }}" class="btn btn-info text-white mr-2 btn-sm">
                        Generate Sitemap
                    </a>
                     <a href="{{ route('admin.mwz.slug.add') }}" class="btn btn-secondary text-white mr-2 btn-sm">
                        Add
                    </a>
                </div>
            </div>
                        ...
                        <table id="slug-datatable" class="table table-bordered key-buttons text-nowrap w-100">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0" width="5%">{{ __('mwz::module.datatable.manage') }}</th>
                                </tr>
                            </thead>
                            <tbody>
