        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">{{ __('websetting_admin.setting') }}</div>
                </div>
                <div class="card-body pt-0">
                    <div class="table-responsive">
                        <table id="websetting-datatable" class="table table-bordered key-buttons text-nowrap w-100">
                            <thead>
                            <tr>
                                <th class="border-bottom-0" width="5%">{{ __('websetting_admin.sequence') }}</th>
                                <th class="border-bottom-0" width="20%">{{ __('websetting_admin.update_at') }}</th>
                                <th class="border-bottom-0" width="15%">{{ __('websetting_admin.manage') }}</th>
                            </tr>
                            </thead>
                            <tbody>
