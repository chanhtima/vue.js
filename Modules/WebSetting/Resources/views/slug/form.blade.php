...
@section('content')
    ...
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">
                <a href="{{ route('admin.setting.slug.index') }}">ตั้งค่า Slug</a>
            </li>
    ...
    <div class="row">
        <div class="col-md-12">
            <form id="slug_frm" name="slug_frm" method="POST" onsubmit="setSlugSave(); return false;"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group m-0">
                            <div class="btn-list">
                                ...
                                <button onclick="mwz_redirect('{{ route('admin.setting.slug.index') }}');"
