...
@section('content')
    ...
    <div class="page-header">
        ...
        @if (mwz_roles('admin.user.role.add'))
            <div class="ml-auto">
                <div class="input-group">
                    <a href="{{ route('admin.user.role.add') }}" class="btn btn-secondary text-white mr-2 btn-sm"
                        ...
                        <table id="role-datatable" class="table table-bordered key-buttons text-nowrap w-100">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0" width="80%">{{__('user::role.datatable.name')}}</th>
                                    <th class="border-bottom-0" width="">{{__('user::role.datatable.updated_at')}}</th>
                                    <th class="border-bottom-0" width="5%">{{__('user::role.datatable.manage')}}</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
