...
@section('content')
    ...
    <div class="page-header">
        ...
        @if (mwz_roles('admin.banner.category.add'))
            <div class="ml-auto">
                <div class="input-group">
                    <a href="{{ route('admin.banner.category.add') }}" class="btn btn-secondary text-white mr-2 btn-sm" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="Add">
                        <span>
