                    ...
                    <div class="card-body">
                        <div class="panel panel-primary">
                            ...
                            <div class="form-group image_banner {{ !empty($data->type) ? $data->type == 1 ? "" : "d-none" : "" }}" >
                                <?= image_upload($id = '1', $name = 'image', $label = __('websetting_admin.upload_image_header'), $image = !empty($data->image) ? $data->image : '', $size_recommend = '2100 x 900px',false,true,'ลบรูปภาพ','DeleteImage') ?>
                            </div>
                            ...
                            <div class="form-group vdo_banner  {{ !empty($data->type) ? $data->type == 2 ? "" : "d-none" : "d-none" }}">
                                ...
                                <small>(หมายเหตุ ความยาววีดีโอแนะนำอยู่ที่ 15 - 18 วินาที)</small>
                            </div>
