...
<div class="tab_content active">
    ...
    {{-- <div class="form-group">
        ...
        <textarea id="description_th" class="form-control texteditor" name="description_th" rows="4"
            placeholder="{{ __('banner_admin.description_placeholder_th') }}">{{ !empty($data->description_th) ? $data->description_th : '' }}</textarea>
    </div> --}}
    {{-- End Input --}}
</div>
{{-- End Tap 1 --}}
