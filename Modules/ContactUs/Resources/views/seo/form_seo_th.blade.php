...
<div class="tab_content active">
    <input type="hidden" name="metadata[th][module]" value="contact">
    <input type="hidden" name="metadata[th][method]" value="contact">
    <input type="hidden" name="metadata[th][level]" value="1">
