...
@section('content')
    ...
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ __('menu_admin.contact_subject') }}</li>
        </ol><!-- End breadcrumb -->
        <div class="ml-auto">
            <div class="input-group">
                <a href="{{ route('admin.contactus.subject.add') }}" class="btn btn-secondary text-white mr-2 btn-sm"
            ...
            <div class="card">
                ...
                <div class="card-body ">
                    ...
                    <div class="table-responsive">
                        <table id="subject-datatable" class="table table-bordered key-buttons text-nowrap w-100"
                            style="width: 100%">
                            <thead>
                                <tr>
                                    <th class="border-bottom-0" width="5%">{{ __('contact_admin.no') }}</th>
                                    <th class="border-bottom-0" width="25%">
                                        {{ __('contact_admin.name_subject') }}</th>
