...
@section('content')
    ...
    <div class="page-header">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a
                    href="{{ route('admin.contactus.subject.index') }}">{{ __('menu_admin.contact_subject') }}</a>
            </li>
    ...
    <div class="row">
        <div class="col-md-12">
            <form id="subject_frm" name="subject_frm" method="POST" onsubmit="setSaveSubject(); return false;">
                @csrf
                <input type="hidden" name="id" value="{{ !empty($data->id) ? $data->id : '0' }}">
                <div class="card">
                    <div class="card-body">
                        <div class="panel panel-primary">
                            <div class="tab_wrapper" id="contact-subject-tab">
                                <ul class="tab_list">
                                ...
                                <div class="content_wrapper">
                                    {{-- !-- form_contact_subject_th --> --}}
                                    @includeIf('contactus::subject.form_th')
                                    <!-- .form_contact_subject_th -->
                                    <!-- form_contact_subject_en -->
                                    @includeIf('contactus::subject.form_en')
                                    <!-- .form_contact_subject_en -->
                        ...
                        <!-- form_contact_subject_other -->
                        @includeIf('contactus::subject.form_other')
                        <!-- .form_contact_subject_other -->
                        ...
                        <div class="form-group m-0">
                            <div class="btn-list">
                                ...
                                <button onclick="mwz_redirect('{{ route('admin.contactus.subject.index') }}');"
