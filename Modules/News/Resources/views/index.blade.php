...
@section('content')
    ...
    <div class="page-header">
        <ol class="breadcrumb"><!-- breadcrumb -->
            ...
            <li class="breadcrumb-item active" aria-current="page">{{__('news_admin.news')}}</li>
        </ol><!-- End breadcrumb -->
        <div class="ml-auto">
            <div class="input-group">
                <a href="{{ route('admin.news.news.add') }}" class="btn btn-secondary text-white mr-2 btn-sm" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="Add">
				    <span>
        ...
        <div class="col-md-12 col-lg-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title">{{__('news_admin.news')}}</div>
                </div>
                <div class="card-body pt-0">
                    <div class="table-responsive">
                        <table id="news-datatable" class="table table-bordered key-buttons text-nowrap">
                            <thead>
                            <tr>
                                <th class="border-bottom-0" width="5%">{{__('news_admin.no')}}</th>
                                <th class="border-bottom-0" width="5%">{{__('news_admin.image')}}</th>
