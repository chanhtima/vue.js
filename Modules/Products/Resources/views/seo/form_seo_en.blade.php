...
<div class="tab_content">
    <input type="hidden" name="metadata[en][module]" value="{{ !empty($metadata['en']['module']) ? $metadata['en']['module'] : 'product' }}">
    <input type="hidden" name="metadata[en][method]" value="{{ !empty($metadata['en']['method']) ? $metadata['en']['method'] : 'productDetail' }}">
    <input type="hidden" name="metadata[en][level]" value="3">
