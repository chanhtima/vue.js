							...
							<table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; background-color: #ffffff; margin: 0 auto; padding: 0; width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 570px;">
								...
								<tr>
									<td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
										...
										<h2 style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #2F3133; font-size: 16px; font-weight: bold; margin-top: 0; text-align: left;">ORDER UPDATE</h2>
										...
										<h2 style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #2F3133; font-size: 15px; font-weight: 500;text-align: left; background-color: #edeff2; padding: 20px; margin: 0;">
											...
											ORDER NUMBER. <strong style="color: #333;float: right;">{{ $event->order['order_id'] }}</strong><br><br>
											@if($event->order['payment_status'] == 1)

											ORDER PAYMENT. <strong style="color: green;float: right;">Confirmed Payment</strong><br>
											ORDER PAYMENT AMOUNT. <strong style="color: #333; float: right;">฿{{ $event->order['payment_amount'] }}</strong><br> 
											ORDER PAYMENT DATE. <strong style="color: #333; float: right;">{{ $event->order['payment_date'] }}</strong> 

											@elseif($event->order['payment_status'] == 0)

											ORDER PAYMENT. <strong style="color: red;float: right;">Not Confirm</strong><br>
