							...
							<table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; background-color: #ffffff; margin: 0 auto; padding: 0; width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 570px;">
								...
								<tr>
									<td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
										<h1 style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #2F3133; font-size: 19px; font-weight: bold; margin-top: 0; text-align: left;">ข้อความติดต่อเรา</h1>
										<p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 14px; line-height: 1.5em; margin-top: 0; text-align: left;">มีข้อความจากหน้าแบบฟอร์มติดต่อเรา มีรายละเอียดดังนี้
											<br><br/>
											ชื่อ : {{ $contact_detail['name'] }}<br/>
											อีเมล : {{ $contact_detail['email'] }}<br/>
											เบอร์โทรสัพท์ : {{ $contact_detail['phone'] }}<br/>
											หัวข้อ : {{ $contact_detail['subject'] }}<br/>
											ข้อความ : {{ $contact_detail['message'] }}<br/>
										</p>
									</td>
								</tr>
